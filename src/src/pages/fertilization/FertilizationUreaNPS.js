    ...
    return (
        <div>
            ...
            <div className='mt-3'>
                ...
                <h2 className="font-link text-center">Fertilizer advisories DAP, NPS & Urea</h2>
                ...
                <p className="font-link-body">
                The amount of DAP, NPS, and Urea that should be recommended to get optimal yield.
                </p>
            </div>
            ...
            <div style={{'position': 'relative'}}>
                ...
                {opt_forecast.length > 0 && forecast && opt_crops.length > 0 && crop &&
                    <>
                        <Sidebar opt_forecast={opt_forecast} opt_crops={opt_crops} opt_scenarios={opt_scenarios} scenario={scenario} OnChangeForecast={changeForecast} OnChangeCrop={changeCrop} OnChangeScenario={changeScenario}/>

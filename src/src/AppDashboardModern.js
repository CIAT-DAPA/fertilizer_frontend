...
import DashboardLayoutModern from './components/dashboard/DashboardLayoutModern';
...
/**
 * Modern dashboard shell — same routes and Redux as App.js / AppDashboard.js.
 * Use via index.dashboard.modern.js (see RUN_DASHBOARD.md).
 */
class AppDashboardModern extends Component {
  render() {
    return (
      <Provider store={store}>
        <Router>
          <div className="container-fluid">
            <MenuDashboard />
            <Routes>
              <Route path="/dashboard" element={<DashboardLayoutModern />}>
                <Route index element={<DashboardHomeModern />} />
                <Route path="location" element={<DashboardLocation />} />
                <Route path="advisories" element={<DashboardAdvisories />} />
...
export default AppDashboardModern;
